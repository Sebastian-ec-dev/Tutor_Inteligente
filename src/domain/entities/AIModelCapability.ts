...
export const AI_MODEL_CAPABILITIES: AIModelCapability[] = [
  {
    ...
    bestFor:
      "clases teóricas, resúmenes rápidos, explicación de conceptos y organización de apuntes.",
  ...
  },
  {
    ...
    bestFor:
      "problemas matemáticos, razonamiento paso a paso, ejercicios con fórmulas e interpretación de imágenes.",
  ...
  },
  {
    ...
    bestFor:
      "convertir grabaciones de clase en texto limpio para que luego el core genere resúmenes, tareas y contexto directo para el chat.",
    usedWhen: "Se usa en la etapa de audio antes del análisis académico.",
  },
];

export function getModelCapabilityByContentType(
  contentType: ClassContentType,
): AIModelCapability {
  return (
    AI_MODEL_CAPABILITIES.find((model) =>
      model.contentTypes?.includes(contentType),
